...
class QuerySql
	...
	def get_author(get_author_args)
		@pool.with do |client|
			...
			result = stmt.execute(GetAuthorSql, query_params)
			row = result.first
	...
	def list_authors
		@pool.with do |client|
			...
			result = stmt.execute(ListAuthorsSql)
			entities = []
			result.each do |row|
	...
	def create_author(create_author_args)
		@pool.with do |client|
			...
			stmt.execute(CreateAuthorSql, query_params)
		end
	end
	...
	def update_author(update_author_args)
		@pool.with do |client|
			...
			stmt.execute(UpdateAuthorSql, query_params)
		end
	end
	...
	def create_author_return_id(create_author_return_id_args)
		@pool.with do |client|
			...
			stmt.execute(CreateAuthorReturnIdSql, query_params)
	...
	def delete_author(delete_author_args)
		@pool.with do |client|
			...
			stmt.execute(DeleteAuthorSql, query_params)
		end
	end
